...
CMD DJANGO_SETTINGS_MODULE=demo_project.settings.live python /app/manage.py createcachetable & \
    DJANGO_SETTINGS_MODULE=demo_project.settings.live python /app/manage.py migrate & \
